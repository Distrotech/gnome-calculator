...
static Number* modulus_divide_node_real_solve (ParseNode* base) {
	...
	if (G_TYPE_CHECK_INSTANCE_TYPE (_tmp0_, TYPE_XPOW_YNODE)) {
		...
		if (_tmp15_) {
			result = NULL;
			_number_unref0 (mod);
			_number_unref0 (exponent);
			_number_unref0 (base_value);
			return result;
		}
		_tmp16_ = base_value;
		_tmp17_ = exponent;
		_tmp18_ = mod;
		_tmp19_ = number_modular_exponentiation (_tmp16_, _tmp17_, _tmp18_);
		result = _tmp19_;
		_number_unref0 (mod);
		_number_unref0 (exponent);
		_number_unref0 (base_value);
		...
		_tmp23_ = parse_node_solve (_tmp22_);
		r = _tmp23_;
		_tmp25_ = l;
		if (_tmp25_ == NULL) {
			_tmp24_ = TRUE;
		...
		_tmp28_ = l;
		_tmp29_ = r;
		_tmp30_ = lr_node_solve_lr ((LRNode*) self, _tmp28_, _tmp29_);
		result = _tmp30_;
		_number_unref0 (r);
		_number_unref0 (l);
		return result;
...
static void modulus_divide_node_class_init (ModulusDivideNodeClass * klass) {
	...
	PARSE_NODE_CLASS (klass)->solve = modulus_divide_node_real_solve;
...
static gboolean parser_variable (Parser* self) {
	...
	if (_tmp3_ == LEXER_TOKEN_TYPE_FUNCTION) {
		...
		LexerToken* _tmp9_;
		LexerTokenType _tmp10_;
		_tmp4_ = self->priv->depth_level;
		self->priv->depth_level = _tmp4_ + 1;
		_tmp5_ = token;
		_tmp6_ = _lexer_token_ref0 (_tmp5_);
		token_old = _tmp6_;
		_tmp7_ = self->priv->lexer;
		_tmp8_ = lexer_get_next_token (_tmp7_);
		_lexer_token_unref0 (token);
		...
		_tmp9_ = token;
		_tmp10_ = _tmp9_->type;
		if (_tmp10_ == LEXER_TOKEN_TYPE_SUP_NUMBER) {
			LexerToken* _tmp11_;
			LexerToken* _tmp12_;
			LexerTokenType _tmp13_;
			guint _tmp14_ = 0U;
			...
			FunctionWithPowerNode* _tmp20_;
			gboolean _tmp21_ = FALSE;
			Lexer* _tmp23_;
			LexerToken* _tmp24_ = NULL;
			LexerToken* _tmp25_;
			LexerTokenType _tmp26_;
			guint _tmp36_;
			gboolean _tmp37_ = FALSE;
			_tmp11_ = token_old;
			_tmp12_ = token_old;
			_tmp13_ = _tmp12_->type;
			_tmp14_ = parser_make_precedence_t (self, _tmp13_);
			_tmp15_ = token_old;
			_tmp16_ = parser_get_associativity (self, _tmp15_);
			_tmp17_ = token;
			_tmp18_ = _tmp17_->text;
			_tmp19_ = function_with_power_node_new (self, _tmp11_, _tmp14_, _tmp16_, _tmp18_);
			_tmp20_ = _tmp19_;
			parser_insert_into_tree_unary (self, (ParseNode*) _tmp20_);
			_parse_node_unref0 (_tmp20_);
			_tmp21_ = parser_expression_1 (self);
			if (!_tmp21_) {
				guint _tmp22_;
				_tmp22_ = self->priv->depth_level;
				self->priv->depth_level = _tmp22_ - 1;
				result = FALSE;
				_lexer_token_unref0 (token_old);
				_lexer_token_unref0 (token);
				return result;
			...
			if (_tmp26_ == LEXER_TOKEN_TYPE_FACTORIAL) {
				LexerToken* _tmp27_;
				LexerToken* _tmp28_;
				LexerTokenType _tmp29_;
				guint _tmp30_ = 0U;
				...
				_tmp33_ = factorial_node_new (self, _tmp27_, _tmp30_, _tmp32_);
				_tmp34_ = _tmp33_;
				parser_insert_into_tree_unary (self, (ParseNode*) _tmp34_);
				_parse_node_unref0 (_tmp34_);
			} else {
				Lexer* _tmp35_;
				_tmp35_ = self->priv->lexer;
				lexer_roll_back (_tmp35_);
			}
			_tmp36_ = self->priv->depth_level;
			self->priv->depth_level = _tmp36_ - 1;
			_tmp37_ = parser_expression_2 (self);
			if (!_tmp37_) {
				result = FALSE;
				_lexer_token_unref0 (token_old);
				_lexer_token_unref0 (token);
			...
			if (_tmp39_ == LEXER_TOKEN_TYPE_NSUP_NUMBER) {
				LexerToken* _tmp40_;
				LexerToken* _tmp41_;
				LexerTokenType _tmp42_;
				guint _tmp43_ = 0U;
				LexerToken* _tmp44_;
				Associativity _tmp45_ = 0;
				LexerToken* _tmp46_;
				const gchar* _tmp47_;
				FunctionWithNegativePowerNode* _tmp48_;
				FunctionWithNegativePowerNode* _tmp49_;
				...
				_tmp43_ = parser_make_precedence_t (self, _tmp42_);
				_tmp44_ = token_old;
				_tmp45_ = parser_get_associativity (self, _tmp44_);
				_tmp46_ = token;
				_tmp47_ = _tmp46_->text;
				_tmp48_ = function_with_negative_power_node_new (self, _tmp40_, _tmp43_, _tmp45_, _tmp47_);
				_tmp49_ = _tmp48_;
				parser_insert_into_tree_unary (self, (ParseNode*) _tmp49_);
				_parse_node_unref0 (_tmp49_);
				_tmp50_ = parser_expression_1 (self);
				if (!_tmp50_) {
					guint _tmp51_;
					_tmp51_ = self->priv->depth_level;
					self->priv->depth_level = _tmp51_ - 1;
					result = FALSE;
					_lexer_token_unref0 (token_old);
					_lexer_token_unref0 (token);
					return result;
				...
				if (_tmp55_ == LEXER_TOKEN_TYPE_FACTORIAL) {
					LexerToken* _tmp56_;
					LexerToken* _tmp57_;
					LexerTokenType _tmp58_;
					guint _tmp59_ = 0U;
					LexerToken* _tmp60_;
					Associativity _tmp61_ = 0;
					FactorialNode* _tmp62_;
					FactorialNode* _tmp63_;
					_tmp56_ = token;
					_tmp57_ = token;
					_tmp58_ = _tmp57_->type;
					_tmp59_ = parser_make_precedence_t (self, _tmp58_);
					_tmp60_ = token;
					_tmp61_ = parser_get_associativity (self, _tmp60_);
					_tmp62_ = factorial_node_new (self, _tmp56_, _tmp59_, _tmp61_);
					_tmp63_ = _tmp62_;
					parser_insert_into_tree_unary (self, (ParseNode*) _tmp63_);
					_parse_node_unref0 (_tmp63_);
				} else {
					Lexer* _tmp64_;
					_tmp64_ = self->priv->lexer;
					lexer_roll_back (_tmp64_);
				}
				_tmp65_ = self->priv->depth_level;
				self->priv->depth_level = _tmp65_ - 1;
				_tmp66_ = parser_expression_2 (self);
				if (!_tmp66_) {
					result = FALSE;
					_lexer_token_unref0 (token_old);
					_lexer_token_unref0 (token);
				...
				guint _tmp71_ = 0U;
				LexerToken* _tmp72_;
				Associativity _tmp73_ = 0;
				FunctionNode* _tmp74_;
				FunctionNode* _tmp75_;
				...
				_tmp67_ = self->priv->lexer;
				lexer_roll_back (_tmp67_);
				_tmp68_ = token_old;
				_tmp69_ = token_old;
				_tmp70_ = _tmp69_->type;
				_tmp71_ = parser_make_precedence_t (self, _tmp70_);
				_tmp72_ = token_old;
				_tmp73_ = parser_get_associativity (self, _tmp72_);
				_tmp74_ = function_node_new (self, _tmp68_, _tmp71_, _tmp73_);
				_tmp75_ = _tmp74_;
				parser_insert_into_tree_unary (self, (ParseNode*) _tmp75_);
				_parse_node_unref0 (_tmp75_);
				_tmp76_ = parser_expression_1 (self);
				if (!_tmp76_) {
					guint _tmp77_;
					_tmp77_ = self->priv->depth_level;
					self->priv->depth_level = _tmp77_ - 1;
					result = FALSE;
					_lexer_token_unref0 (token_old);
					_lexer_token_unref0 (token);
					return result;
				...
				if (_tmp81_ == LEXER_TOKEN_TYPE_FACTORIAL) {
					LexerToken* _tmp82_;
					LexerToken* _tmp83_;
					LexerTokenType _tmp84_;
					guint _tmp85_ = 0U;
					LexerToken* _tmp86_;
					Associativity _tmp87_ = 0;
					FactorialNode* _tmp88_;
					FactorialNode* _tmp89_;
					_tmp82_ = token;
					_tmp83_ = token;
					_tmp84_ = _tmp83_->type;
					_tmp85_ = parser_make_precedence_t (self, _tmp84_);
					_tmp86_ = token;
					_tmp87_ = parser_get_associativity (self, _tmp86_);
					_tmp88_ = factorial_node_new (self, _tmp82_, _tmp85_, _tmp87_);
					_tmp89_ = _tmp88_;
					parser_insert_into_tree_unary (self, (ParseNode*) _tmp89_);
					_parse_node_unref0 (_tmp89_);
				} else {
					Lexer* _tmp90_;
					_tmp90_ = self->priv->lexer;
					lexer_roll_back (_tmp90_);
				}
				_tmp91_ = self->priv->depth_level;
				self->priv->depth_level = _tmp91_ - 1;
				_tmp92_ = parser_expression_2 (self);
				if (!_tmp92_) {
					result = FALSE;
					_lexer_token_unref0 (token_old);
					_lexer_token_unref0 (token);
		...
		if (_tmp94_ == LEXER_TOKEN_TYPE_SUB_NUMBER) {
			LexerToken* _tmp95_;
			LexerToken* _tmp96_;
			LexerToken* token_old;
			Lexer* _tmp97_;
			...
			LexerToken* _tmp99_;
			LexerTokenType _tmp100_;
			_tmp95_ = token;
			_tmp96_ = _lexer_token_ref0 (_tmp95_);
			token_old = _tmp96_;
			_tmp97_ = self->priv->lexer;
			_tmp98_ = lexer_get_next_token (_tmp97_);
			_lexer_token_unref0 (token);
			token = _tmp98_;
			_tmp99_ = token;
			_tmp100_ = _tmp99_->type;
			if (_tmp100_ == LEXER_TOKEN_TYPE_ROOT) {
				LexerToken* _tmp101_;
				LexerToken* _tmp102_;
				LexerTokenType _tmp103_;
				guint _tmp104_ = 0U;
				LexerToken* _tmp105_;
				Associativity _tmp106_ = 0;
				LexerToken* _tmp107_;
				...
				_tmp104_ = parser_make_precedence_t (self, _tmp103_);
				_tmp105_ = token;
				_tmp106_ = parser_get_associativity (self, _tmp105_);
				_tmp107_ = token_old;
				_tmp108_ = _tmp107_->text;
				_tmp109_ = sub_atoi (_tmp108_);
				_tmp110_ = root_node_new (self, _tmp101_, _tmp104_, _tmp106_, _tmp109_);
				_tmp111_ = _tmp110_;
				parser_insert_into_tree_unary (self, (ParseNode*) _tmp111_);
				_parse_node_unref0 (_tmp111_);
				_tmp112_ = parser_expression (self);
				if (!_tmp112_) {
					result = FALSE;
					_lexer_token_unref0 (token_old);
					_lexer_token_unref0 (token);
			...
			_tmp113_ = token;
			_tmp114_ = _tmp113_->type;
			if (_tmp114_ == LEXER_TOKEN_TYPE_ROOT) {
				LexerToken* _tmp115_;
				LexerToken* _tmp116_;
				LexerTokenType _tmp117_;
				guint _tmp118_ = 0U;
				LexerToken* _tmp119_;
				...
				_tmp118_ = parser_make_precedence_t (self, _tmp117_);
				_tmp119_ = token;
				_tmp120_ = parser_get_associativity (self, _tmp119_);
				_tmp121_ = root_node_new (self, _tmp115_, _tmp118_, _tmp120_, 2);
				_tmp122_ = _tmp121_;
				parser_insert_into_tree_unary (self, (ParseNode*) _tmp122_);
				_parse_node_unref0 (_tmp122_);
				...
				if (_tmp125_ == LEXER_TOKEN_TYPE_ROOT_3) {
					LexerToken* _tmp126_;
					LexerToken* _tmp127_;
					LexerTokenType _tmp128_;
					guint _tmp129_ = 0U;
					LexerToken* _tmp130_;
					Associativity _tmp131_ = 0;
					RootNode* _tmp132_;
					RootNode* _tmp133_;
					...
					_tmp129_ = parser_make_precedence_t (self, _tmp128_);
					_tmp130_ = token;
					_tmp131_ = parser_get_associativity (self, _tmp130_);
					_tmp132_ = root_node_new (self, _tmp126_, _tmp129_, _tmp131_, 3);
					_tmp133_ = _tmp132_;
					parser_insert_into_tree_unary (self, (ParseNode*) _tmp133_);
					_parse_node_unref0 (_tmp133_);
					_tmp134_ = parser_expression (self);
					if (!_tmp134_) {
						result = FALSE;
						_lexer_token_unref0 (token);
						return result;
					...
					_tmp135_ = token;
					_tmp136_ = _tmp135_->type;
					if (_tmp136_ == LEXER_TOKEN_TYPE_ROOT_4) {
						LexerToken* _tmp137_;
						LexerToken* _tmp138_;
						LexerTokenType _tmp139_;
						guint _tmp140_ = 0U;
						...
						_tmp143_ = root_node_new (self, _tmp137_, _tmp140_, _tmp142_, 4);
						_tmp144_ = _tmp143_;
						parser_insert_into_tree_unary (self, (ParseNode*) _tmp144_);
						_parse_node_unref0 (_tmp144_);
						_tmp145_ = parser_expression (self);
						if (!_tmp145_) {
							result = FALSE;
							_lexer_token_unref0 (token);
							return result;
						...
						_tmp146_ = token;
						_tmp147_ = _tmp146_->type;
						if (_tmp147_ == LEXER_TOKEN_TYPE_VARIABLE) {
							Lexer* _tmp148_;
							gboolean _tmp149_ = FALSE;
							_tmp148_ = self->priv->lexer;
							lexer_roll_back (_tmp148_);
							_tmp149_ = parser_term (self);
							if (!_tmp149_) {
								result = FALSE;
								_lexer_token_unref0 (token);
								return result;
