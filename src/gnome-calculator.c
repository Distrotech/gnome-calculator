...
"51 Franklin Street, Fifth Floor, Boston, MA 02110-1301, USA");
	...
	_tmp12_ = _ ("About Calculator");
	_tmp13_ = _ ("Calculator with financial and scientific modes.");
	gtk_show_about_dialog ((GtkWindow*) _tmp10_, "program-name", _tmp11_, "title", _tmp12_, "version", VERSION, "copyright", "\xc2\xa9 1986–2012 The Calculator authors", "license", license, "comments", _tmp13_, "authors", authors, "documenters", documenters, "translator_credits", translator_credits, "logo-icon-name", "accessories-calculator", NULL);
	_g_free0 (license);
