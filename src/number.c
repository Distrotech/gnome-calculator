...
GList* number_factorize (Number* self) {
	...
	if (_tmp18_ <= 0) {
		...
		if (_tmp22_) {
			...
			_number_unref0 (_tmp23_->data);
			_tmp23_->data = _tmp26_;
		}
		result = factors_int64;
		_number_unref0 (int_max);
		_number_unref0 (value);
	...
	while (TRUE) {
		...
		if (_tmp32_) {
			...
			Number* _tmp36_;
			_tmp33_ = tmp;
			_tmp34_ = _number_ref0 (_tmp33_);
			_number_unref0 (value);
			value = _tmp34_;
			_tmp35_ = divisor;
			_tmp36_ = _number_ref0 (_tmp35_);
	...
	_tmp64_ = _tmp63_ > 0;
	_number_unref0 (_tmp62_);
	if (_tmp64_) {
		Number* _tmp65_;
		Number* _tmp66_;
		_tmp65_ = value;
		_tmp66_ = _number_ref0 (_tmp65_);
		...
		divisor = (guint64) 3;
		{
			...
			while (TRUE) {
				...
				while (TRUE) {
					...
					n = _tmp11_ / _tmp12_;
					_tmp13_ = divisor;
					_tmp14_ = number_new_unsigned_integer (_tmp13_);
					factors = g_list_append (factors, _tmp14_);
				}
			}
		}
	}
	_tmp15_ = n;
	if (_tmp15_ > ((guint64) 1)) {
		guint64 _tmp16_;
		Number* _tmp17_;
		_tmp16_ = n;
		_tmp17_ = number_new_unsigned_integer (_tmp16_);
		factors = g_list_append (factors, _tmp17_);
	}
	result = factors;
	return result;
}
