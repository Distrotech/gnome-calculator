...
static void ___lambda32__gtk_spin_button_value_changed (GtkSpinButton* _sender, gpointer self);
...
static void __lambda35_ (Block1Data* _data1_, GParamSpec* pspec);
...
static void __lambda40_ (Block1Data* _data1_, GParamSpec* pspec);
...
MathPreferencesDialog* math_preferences_dialog_construct (GType object_type, MathEquation* equation) {
	...
	g_signal_connect_data (_tmp88_, "value-changed", (GCallback) ___lambda32__gtk_spin_button_value_changed, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
	_tmp89_ = places_box;
	...
	g_signal_connect_data ((GtkToggleButton*) _tmp105_, "toggled", (GCallback) ___lambda33__gtk_toggle_button_toggled, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
	...
	g_signal_connect_data ((GtkToggleButton*) _tmp111_, "toggled", (GCallback) ___lambda34__gtk_toggle_button_toggled, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
	...
	g_signal_connect_data ((GObject*) _tmp195_, "notify::accuracy", (GCallback) ___lambda35__g_object_notify, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
	...
	g_signal_connect_data ((GObject*) _tmp200_, "notify::show-thousands-separators", (GCallback) ___lambda36__g_object_notify, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
	...
	g_signal_connect_data ((GObject*) _tmp205_, "notify::show-trailing_zeroes", (GCallback) ___lambda37__g_object_notify, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
	...
	g_signal_connect_data ((GObject*) _tmp210_, "notify::number-format", (GCallback) ___lambda38__g_object_notify, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
	...
	g_signal_connect_data ((GObject*) _tmp215_, "notify::word-size", (GCallback) ___lambda39__g_object_notify, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
	...
	g_signal_connect_data ((GObject*) _tmp220_, "notify::angle-units", (GCallback) ___lambda40__g_object_notify, block1_data_ref (_data1_), (GClosureNotify) block1_data_unref, 0);
